...
contract ZkSeaNFT is ERC721Enumerable{
    ...
    function create(uint256 collectionid,address to,string memory _tokenURI,string memory _mintname,string memory _nftowner,uint256 _copies,string memory description) external payable
    {
    ...
    function createMulti(uint256 collectionid,address to,string memory _tokenURI,string memory _mintname,string memory _nftowner,uint256 _copies,string memory description, uint256 _times, uint256 _price) external payable
    {
